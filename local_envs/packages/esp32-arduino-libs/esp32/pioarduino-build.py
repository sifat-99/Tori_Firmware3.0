...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_matter", "data_model"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_matter", "data_model_provider"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "common", "ble_log", "deprecated", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_psram", "device", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__rmaker_cmd_resp", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__rmaker_common_events", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__rmaker_system_ctrl", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__rmaker_time_sync", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__rmaker_console", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__rmaker_work_queue", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp-modbus", "modbus", "mb_transports"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp-modbus", "modbus", "mb_controller", "common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp-modbus", "modbus", "mb_objects", "common"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp-modbus", "modbus", "mb_ports", "common"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp-modbus", "modbus", "mb_ports", "serial"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp-modbus", "modbus", "mb_ports", "tcp"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_daylight", "include"),
