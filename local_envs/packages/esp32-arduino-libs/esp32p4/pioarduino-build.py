...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_video", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "ov2640", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "ov5640", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "ov5645", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "ov5647", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "ov9281", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "sc2336", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "sti2250", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "sc202cs", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "gc0308", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "gc2145", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "mt9d111", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "os02n10", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "os04c10", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "sc101iot", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "sc030iot", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "ov2710", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "ov3660", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "sc035hgs", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "bf3925", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "mira220", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "bf3a03", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "bf20a6", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "bf3045", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "arducam", "pivariety", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_cam_sensor", "sensors", "arducam", "imx500", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_sccb_intf", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_sccb_intf", "interface"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_sccb_intf", "sccb_i2c", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_psram", "device", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "ble_log", "deprecated", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_h264", "interface", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_h264", "sw", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_h264", "port", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_h264", "hw", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_ipa", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__usb_host_uvc", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "chmorgan__esp-libhelix-mp3", "libhelix-mp3", "pub"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-modbus", "modbus", "mb_transports"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-modbus", "modbus", "mb_controller", "common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-modbus", "modbus", "mb_objects", "common"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-modbus", "modbus", "mb_ports", "common"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-modbus", "modbus", "mb_ports", "serial"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-modbus", "modbus", "mb_ports", "tcp"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__cjson", "cJSON"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-sr", "include", "esp32p4"),
